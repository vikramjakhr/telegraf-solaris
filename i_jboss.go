...
func (h *JBoss) Gather(acc Accumulator) error {
...
func (h *JBoss) processEJBAppStats(acc Accumulator, ejb map[string]interface{}, tags map[string]string) error {
	fields := make(map[string]interface{})
...
func (h *JBoss) processWebAppStats(acc Accumulator, web map[string]interface{}, tags map[string]string) error {
	fields := make(map[string]interface{})
