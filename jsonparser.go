...
func (p *JSONParser) parseArray(buf []byte) ([]Metric, error) {
...
func (p *JSONParser) parseObject(metrics []Metric, jsonOut map[string]interface{}) ([]Metric, error) {
	...
	metric, err := New(p.MetricName, tags, f.Fields, time.Now().UTC())
